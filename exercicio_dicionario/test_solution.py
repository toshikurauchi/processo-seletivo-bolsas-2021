...
try:
    def teste_string_vazia():
        ...
        assert teste==expected, "\nDica: Sua função não parece funcionar para strings vazias\n"
    ...
    def teste_string_inteira():
        ...
        teste = primeiras_ocorrencias(string)
        assert teste==expected, "\nDica: Verifique se sua função percorre toda a string!\n"
    ...
    def teste_override_primeira():
        ...
        expected = {"a": 0, "b":1}
        teste = primeiras_ocorrencias(string)
        assert teste==expected, "\nDica: Cuidado! Parece que sua função está selecionando as últimas ocorrências, e não as primeiras.\n"
    ...
    def teste_string_pequena():
        ...
        expected = {"a": 0}
        teste = primeiras_ocorrencias(string)
        assert teste==expected, "\nDica: Sua função parece estar falhando com entradas bem pequenas. Reveja seu código e tente novamente\n"
    ...
    def teste_string_grande():
        ...
        teste = primeiras_ocorrencias(string)
        assert teste==expected, "\nDica: Sua função parece estar falhando com entradas bem grandes. Reveja seu código e tente novamente\n"
    ...
    def teste_string_espaco():
        ...
        teste = primeiras_ocorrencias(string)
        assert teste==expected, "\nDica: Preste atenção em strings com espaços. Espaços também contam como caracteres\n"
