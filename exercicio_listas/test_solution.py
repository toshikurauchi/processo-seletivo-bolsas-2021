...
def test_subtracao_de_listas(lista_Maiuscula, lista_letras, lista_letras_final):
...
def test_subtracao_de_listas(lista_anime, lista_fã, lista_anime_final):
    assert subtracao_de_listas(lista_anime, lista_fã) == lista_anime_final

# #verifica lista2_nome e lista_nome_maior

@pytest.mark.parametrize("lista2_nome, lista_nome_maior, lista_maior_final", [(['Quézia Moura', 'Kevin Shinohara', 'Cleilton Sousa'], ['Kevin Shinohara', 'Cleilton Sousa'], ['Quezia Moura'])])

def test_subtracao_de_listas(lista2_nome, lista_nome_maior, lista_maior_final):
...
def test_subtracao_de_listas(lista_name, lista_name_maior, lista_name_final):
...
def test_subtracao_de_listas(lista_variaveis, lista_variaveis_variadas, lista_variaveis_final):
...
def test_subtracao_de_listas(lista_numeros_inteiros, lista_numeros_reais, lista_reais_final):
